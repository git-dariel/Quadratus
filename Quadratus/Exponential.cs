...
namespace Quadratus
{
    public partial class Exponential : Form
    {
        DateTime currentDateTime;
        string formattedDateTime;
        string equationText = "Exponential Equation";
        //int userIdCounter = 1;
        public Exponential()
        {
            InitializeComponent();
        ...
        private async void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            string query = $"Solve the equation y = {a} * {b}^x. And then give me the answer make it professional." +
